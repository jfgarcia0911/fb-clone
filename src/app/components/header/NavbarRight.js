		...
		<>
            ...
            sizes="32px"
				...
				<div
					className={`${
						isOpen ? "block" : "hidden"
					} absolute right-0 z-30 p-2 mt-2 w-60 bg-gray-50 border border-gray-200 rounded-md shadow-lg transition-opacity duration-200`}
				>
					...
					<ul className="p-2 text-sm text-gray-700">
						{session?.user ? (
							<>
								...
								<li
									onClick={logout}
									className=" flex items-center px-4 py-2 rounded-lg hover:bg-gray-300 cursor-pointer group"
								>
									<div className="bg-gray-300 rounded-full p-1 mr-2">
